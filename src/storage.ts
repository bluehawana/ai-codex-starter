...
try {
  ...
  console.warn(chalk.yellow('   Credentials will be stored in plaintext at ~/.ai-codex-profiles.json'));
}

const CONFIG_FILE = process.env.AI_CODEX_CONFIG_PATH || join(homedir(), '.ai-codex-profiles.json');
